...
usage =<<-EOT
  ...
  You will need to have the organism installed. Example: 'rbbt_config prepare organism -o Sce'. Depending on
  the type of ner you will need to do 'rbbt_config prepare java_ner' or 'rbbt_config prepare rner; rbbt_config install ner'.
  
  Example: 
  #{$0} Sce "'saccharomyces cerevisiae' sexual reproduction" rner 500
EOT
